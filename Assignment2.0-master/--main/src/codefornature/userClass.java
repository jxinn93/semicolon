...
public class userClass {
    ...
    public userClass(String email, String username, String password,String regDate, int points, String securityQuestion, String securityAnswer) {
        this.email = email;
     ...
     public static List<userClass> getAllUsers() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                userClass user = new userClass(email, username, password,regDate,  points, securityQuestion, securityAnswer);
                users.add(user);
            }
