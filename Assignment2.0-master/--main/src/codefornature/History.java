...
public class History extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        fQs = new javax.swing.JTextField();
        ...
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 156, 330, 40));

        fQs.setBackground(new java.awt.Color(255, 255, 255));
        fQs.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        fQs.setForeground(new java.awt.Color(0, 51, 51));
        getContentPane().add(fQs, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 190, 330, 50));
    ...
    private javax.swing.JTextField fQs;
